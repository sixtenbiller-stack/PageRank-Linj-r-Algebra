...
class hemsida:
    ...
    def nollställning(self,endastTrusted): #Funktion för att nollställa mellan iterationerna
        if endastTrusted and not self.Trusted:
            return
...
def main():
    ...
    sidlista = LasInFil("SidorTrusted.txt",d)
    ...
    for i in sidlista:
        ...
        i.ökningsFaktor = i.pageRankVärded2 / i.pageRankVärded1 #Hittar faktorn som pagerankvärdet ökade/sänktes med när dämpningen höjdes
        """
